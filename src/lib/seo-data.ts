...
export function generateLocalBusinessSchema(city: CityInfo) {
  return {
    ...
    "image": "https://amberlydigital.com.au/og-image.jpg",
    "url": `https://amberlydigital.com.au/locations/${city.name.toLowerCase()}`,
...
export function generateToolSchema(tool: ToolInfo, city: CityInfo) {
  return {
    ...
    "url": `https://amberlydigital.com.au/tools/${tool.title.toLowerCase().replace(/ /g, "-")}/${city.name.toLowerCase()}`,
